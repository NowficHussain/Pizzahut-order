...
def order(request):
    ...
    if request.method == 'POST':
        ...
        if filled_form.is_valid():
            note='Thanks☺️your order  for %s %s and %s sized pizza has been placed.!'%(filled_form.cleaned_data['topping1'],
